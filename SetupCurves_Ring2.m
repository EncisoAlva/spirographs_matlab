...
%
GlissetteOpts.Method = 'Ring2';
GlissetteOpts.CtrHoleDist   = CtrHoleDist;
GlissetteOpts.HoleRadius    = HoleRadius;
GlissetteOpts.Wheel2Radius  = Wheel2Radius;
GlissetteOpts.Marker2Radius = Marker2Radius;
