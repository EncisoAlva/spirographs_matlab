...
%
%
function MakeVideo_INO( WheelRadius, TimerefCurve, Orientation, ...
  ScalingFactor, ...
  DecorativeBez,...
...
circA = WheelRadius*[cos(aang); sin(aang)];
circB = WheelRadius*[cos(aang); sin(aang)]/ScalingFactor;
...
for i = 0:nTimes
  ...
  %
  fill(RefWheelCtrA(1)+circA(1,:),RefWheelCtrA(2)+circA(2,:), 'cyan', 'EdgeColor', 'none','FaceAlpha',0.15); 
  fill(RefWheelCtrB(1)+circB(1,:),RefWheelCtrB(2)+circB(2,:), 'cyan', 'EdgeColor', 'none','FaceAlpha',0.15); 
