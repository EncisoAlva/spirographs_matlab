...
%%
% letter C from circles, but only the cirumference
LetterC_border = {[...
  [-3,0]',...
  [-3,0]'+3*[0,(4/3)*tan(pi/8)]',...
  [0,3]'+3*[-(4/3)*tan(pi/8),0]',...
...
Bone = {[...
  ...
  [ 0, 1]'...
  [ 0, 1]'+[ 0, 1]'*(4/3)*tan(pi/8),...
  [ 1, 2]'+[-1, 0]'*(4/3)*tan(pi/8),...
  [ 1, 2]'...
  ],[...
  [ 1, 2]'...
  [ 1, 2]'+[ 1, 0]'*(4/3)*tan(pi/8),...
  [ 2, 1]'+[ 0, 1]'*(4/3)*tan(pi/8),...
  [ 2, 1]'...
  ],[...
  [ 2, 1]'...
  [ 2, 1]'+[ 0,-1]'*(4/3)*tan(pi/8),...
...
TwoCircles = {[...
  ...
  [-3, 3]'+[-3, 0]'*(4/3)*tan(pi/8),...
  [-3, 3]'...
  ],[...
  [-3, 3]',...
  [-3, 3]'+[ 3, 0]'*(4/3)*tan(pi/8),...
  [ 0, 0]'+[ 0, 3]'*(4/3)*tan(pi/8),...
  [ 0, 0]'...
  ],[...
  [ 0, 0]',...
  [ 0, 0]'+[ 0,-2]'*(4/3)*tan(pi/8),...
  [-2,-2]'+[ 2, 0]'*(4/3)*tan(pi/8),...
  [-2,-2]'...
  ],[...
  [-2,-2]',...
  [-2,-2]'+[-2, 0]'*(4/3)*tan(pi/8),...
  [-4, 0]'+[ 0,-2]'*(4/3)*tan(pi/8),...
  [-4, 0]'...
  ],[...
  [-4, 0]',...
  [-4, 0]'+[ 0, 2]'*(4/3)*tan(pi/8),...
