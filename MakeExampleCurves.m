...
clear R Rr r b t xy xy_der i CurrCurve del_i

%%
% triangle with cycloids
N = 2;
...
Cycloidgon_2 = cell(1,size(Cycloid_base,2)*N);
...
for curr_side = 0:(N-1)
  ...
  % 
  for i = 1:nSegments
    Cycloidgon_2{i+curr_side*nSegments} = Cycloid_rotated{i};
  end
end

clear b bar curr_side CurrCurve Cycloid_base Cycloid_rotated del_i dt i nSegments R ROT t th Tol xy xy_der N
...
for curr_side = 0:(N-1)
  ...
  % 
  for i = 1:nSegments
    Cycloidgon_3{i+curr_side*nSegments} = Cycloid_rotated{i};
  end
end
...
% rotate and concatenate cycloids
Cycloidgon_4 = cell(1,size(Cycloid_base,2)*N);
nSegments = size(Cycloid_base,2);
...
for curr_side = 0:(N-1)
  ...
  % 
  for i = 1:nSegments
    Cycloidgon_4{i+curr_side*nSegments} = Cycloid_rotated{i};
  end
end
...
% rotate and concatenate cycloids
Cycloidgon_5 = cell(1,size(Cycloid_base,2)*N);
nSegments = size(Cycloid_base,2);
...
for curr_side = 0:(N-1)
  ...
  % 
  for i = 1:nSegments
    Cycloidgon_5{i+curr_side*nSegments} = Cycloid_rotated{i};
  end
end
...
% rotate and concatenate cycloids
Cycloidgon_6 = cell(1,size(Cycloid_base,2)*N);
nSegments = size(Cycloid_base,2);
...
for curr_side = 0:(N-1)
  ...
  % 
  for i = 1:nSegments
    Cycloidgon_6{i+curr_side*nSegments} = Cycloid_rotated{i};
  end
end
